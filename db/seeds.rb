...
50.times do
  Book.create(title: Faker::Book.unique.title, description: Faker::Book.genre, isbn: Faker::Code.unique.isbn, visibility: [true, false].sample, creation_date: time_rand, authors: [authors.sample], publisher_id: publishers.sample.id)
end
